...
int multipleBeamSimulator::input_hdf5_all_catheter(const std::string &fileName,const std::string &groupName)
{
  ...
  try
  {
    ...
    string dataName;
    dataName=groupName+"/contact/u_stat_wall_catheter";
    HDF5input::read_2dDOUBLEARRAY(file,dataName,u_stat_wall_catheter);
    dataName=groupName+"/contact/wallContact_catheter";
    HDF5input::read_1dINTARRAY(file,dataName,wallContact_catheter);
...
int multipleBeamSimulator::input_hdf5_restart_catheter(const std::string &fileName,const std::string &groupName)
{
   // Try block to detect exceptions raised by any of the calls inside it
  try
  {
